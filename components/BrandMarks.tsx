...
export function BrandMark({ kind, className = "size-5" }: { kind: AgentKind; className?: string }) {
  if (kind === "claude-code") {
    return (
  ...
  if (kind === "codex") {
    return (
      <svg viewBox="0 0 24 24" className={`${className} brand-invert`} aria-hidden="true">
        <path
          fill="currentColor"
          fillRule="evenodd"
